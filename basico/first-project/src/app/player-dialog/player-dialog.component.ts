...
export class PlayerDialogComponent implements OnInit {
  ...
  private newPlayer(playerFormvalue) {
    ...
    const formattedTeam = {
      ...this.team,
      players: [...(this.team.players ? this.team.players : []), playerFormvalueWithKey]
    };
  ...
  private editPlayer(playerFromValue) {
    const playerFormValueWithKey = {...playerFromValue, $key: this.player.$key};
    const playerFormValueWithFormattedKey = {...playerFromValue, key: this.player.$key};
